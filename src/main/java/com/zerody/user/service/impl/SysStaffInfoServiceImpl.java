...
//        smsFeignService.sendSms(smsDto);
    ...
    @Override
    @Transactional
    public void updateStaff(SetSysUserInfoDto setSysUserInfoDto) throws ParseException, IllegalAccessException {
        // 注* 涉及到离职的修改时 查看 doCopyStaffInner 方法是否也需要修改
...
//            }
        ...
        UserLogUtil.addUserLog(oldUserInfo,UserUtils.getUser(),content,contentList, DataCodeType.PARTNER_MODIFY);
