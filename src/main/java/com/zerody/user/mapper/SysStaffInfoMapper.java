...
public interface SysStaffInfoMapper extends BaseMapper<SysStaffInfo> {
    ...
    IPage<SysStaffInfoVo> selectPageStaffByRoleId(SysStaffInfoPageDto sysStaffInfoPageDto,IPage iPage);

    IPage<SysStaffInfoVo> getPageAllStaff(SysStaffInfoPageDto sysStaffInfoPageDto,IPage iPage);

    List<Integer> selectUserByCompanyId(String companyId);
}